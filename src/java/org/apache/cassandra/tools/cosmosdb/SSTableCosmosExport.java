 ...
 */
public class SSTableCosmosExport
{
     ...
     */
    public static CFMetaData metadataFromSSTable(Descriptor desc, CFMetaData cqlMeta) throws IOException
    {
        ...
        CFMetaData.Builder builder = CFMetaData.Builder.create(desc.ksname, desc.cfname).withPartitioner(partitioner);
    ...
    public static void main(String[] args) throws ConfigurationException
    {
        ...
        String ssTableFileName = ssTableFile.getAbsolutePath();
    ...
    {
        String usage = String.format("sstablecosmosexport <sstable file path> <options>%n");
        String header = "Dump contents of given SSTable to standard output in JSON format.";
        new HelpFormatter().printHelp(usage, header, options, "");
    }
    
    private static void printDebug(Stream<UnfilteredRowIterator> partitions, ISSTableScanner currentScanner, CFMetaData metadata)
    {
